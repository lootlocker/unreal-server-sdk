...
private:
	static void SendNotificationToPlayer(const TSharedPtr<FJsonValue>& Content, const FLootLockerServerSendNotificationsToPlayerBaseRequest& Request, const FLootLockerServerSendNotificationsResponseDelegate& OnCompletedRequest = FLootLockerServerSendNotificationsResponseDelegate());
