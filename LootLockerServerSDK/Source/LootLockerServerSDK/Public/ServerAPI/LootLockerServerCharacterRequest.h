...
class LOOTLOCKERSERVERSDK_API ULootLockerServerCharacterRequest : public UObject
{
    ...
    static void GetPlayerCharacters(int PlayerID, const FLootLockerServerGetPlayerCharacterResponseDelegate& OnCompletedRequest = FLootLockerServerGetPlayerCharacterResponseDelegate());
    static void GetPlayerCharacterInventory(int PlayerID, int CharacterID, const FLootLockerServerGetCharacterInventoryResponseDelegate& OnCompletedRequest = FLootLockerServerGetCharacterInventoryResponseDelegate());
    static void GetPaginatedPlayerCharacterInventory(int PlayerID, int CharacterID, int Count, int After, const FLootLockerServerGetCharacterInventoryResponseDelegate& OnCompletedRequest = FLootLockerServerGetCharacterInventoryResponseDelegate());
    static void GetPlayerCharacterLoadout(int PlayerID, int CharacterID, const FLootLockerServerGetCharacterLoadoutResponseDelegate& OnCompletedRequest = FLootLockerServerGetCharacterLoadoutResponseDelegate());
    static void EquipAssetToPlayerCharacterLoadoutByAssetInstanceId(int PlayerID, int CharacterID, int AssetInstanceID, const FLootLockerServerEquipAssetToCharacterLoadoutResponseDelegate& OnCompletedRequest = FLootLockerServerEquipAssetToCharacterLoadoutResponseDelegate());
    static void EquipAssetToPlayerCharacterLoadoutByAssetIdAndAssetVariationId(int PlayerID, int CharacterID, int AssetID, int AssetVariationID, const FLootLockerServerEquipAssetToCharacterLoadoutResponseDelegate& OnCompletedRequest = FLootLockerServerEquipAssetToCharacterLoadoutResponseDelegate());
    static void EquipAssetToPlayerCharacterLoadoutByAssetIdAndRentalOptionId(int PlayerID, int CharacterID, int AssetID, int RentalOptionID, const FLootLockerServerEquipAssetToCharacterLoadoutResponseDelegate& OnCompletedRequest = FLootLockerServerEquipAssetToCharacterLoadoutResponseDelegate());
	static void UnequipAssetFromPlayerCharacterLoadout(int PlayerID, int CharacterID, int InstanceID, const FLootLockerServerUnequipAssetFromCharacterLoadoutResponseDelegate& OnCompletedRequest = FLootLockerServerUnequipAssetFromCharacterLoadoutResponseDelegate());
};
