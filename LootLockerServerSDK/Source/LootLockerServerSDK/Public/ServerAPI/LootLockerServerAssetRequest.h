...
class LOOTLOCKERSERVERSDK_API ULootLockerServerAssetRequest : public UObject
{
    ...
    static void GetAssets(bool IncludeUGC = false, const FLootLockerServerGetAssetsResponseBP& OnCompletedRequestBP = FLootLockerServerGetAssetsResponseBP(), const FLootLockerServerGetAssetsResponseDelegate& OnCompletedRequest = FLootLockerServerGetAssetsResponseDelegate());
    static void GetPaginatedAssets(int Count, int After, bool IncludeUGC = false, const FLootLockerServerGetAssetsResponseBP& OnCompletedRequestBP = FLootLockerServerGetAssetsResponseBP(), const FLootLockerServerGetAssetsResponseDelegate& OnCompletedRequest = FLootLockerServerGetAssetsResponseDelegate());
