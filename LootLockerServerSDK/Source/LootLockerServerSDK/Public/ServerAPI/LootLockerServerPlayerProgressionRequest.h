...
class LOOTLOCKERSERVERSDK_API ULootLockerServerPlayerProgressionRequest : public UObject
{
    ...
    static void GetProgressionsForPlayer(int PlayerID, const FLootLockerServerPlayerProgressionListResponseDelegate& OnCompletedRequest = FLootLockerServerPlayerProgressionListResponseDelegate());
    static void GetPaginatedProgressionsForPlayer(int PlayerID, int32 Count, const FString& After, const FLootLockerServerPlayerProgressionListResponseDelegate& OnCompletedRequest = FLootLockerServerPlayerProgressionListResponseDelegate());
    static void GetProgressionForPlayerByKey(int PlayerID, const FString& ProgressionKey, const FLootLockerServerSinglePlayerProgressionResponseDelegate& OnCompletedRequest = FLootLockerServerSinglePlayerProgressionResponseDelegate());
    static void AddPointsToProgressionForPlayer(int PlayerID, const FString& ProgressionKey, int32 Amount, const FLootLockerServerSinglePlayerProgressionWithRewardsResponseDelegate& OnCompletedRequest = FLootLockerServerSinglePlayerProgressionWithRewardsResponseDelegate());
    static void SubtractPointsFromProgressionForPlayer(int PlayerID, const FString& ProgressionKey, int32 Amount, const FLootLockerServerSinglePlayerProgressionWithRewardsResponseDelegate& OnCompletedRequest = FLootLockerServerSinglePlayerProgressionWithRewardsResponseDelegate());
    static void ResetProgressionForPlayer(int PlayerID, const FString& ProgressionKey, const FLootLockerServerSinglePlayerProgressionWithRewardsResponseDelegate& OnCompletedRequest = FLootLockerServerSinglePlayerProgressionWithRewardsResponseDelegate());
    static void DeleteProgressionForPlayer(int PlayerID, const FString& ProgressionKey, const FLootLockerServerDeletePlayerProgressionResponseDelegate& OnCompletedRequest = FLootLockerServerDeletePlayerProgressionResponseDelegate());
};
