...
class LOOTLOCKERSERVERSDK_API ULootLockerServerStorageRequest : public UObject
{
	...
	static void GetPersistentStorageForPlayers(TArray<int> PlayerIDs, const FLootLockerServerGetPersistentStorageForPlayersResponseDelegate& OnCompleteResponse = FLootLockerServerGetPersistentStorageForPlayersResponseDelegate());
	static void GetPublicPersistentStorageForPlayersAndKeys(TArray<int> PlayerIDs, TArray<FString> Keys, const FLootLockerServerGetPublicPersistentStorageForPlayersAndKeysResponseDelegate& OnCompleteResponse = FLootLockerServerGetPublicPersistentStorageForPlayersAndKeysResponseDelegate());
	static void UpdatePersistentStorageForPlayersAndKeys(TArray<FLootLockerServerPlayerPersistentStorageEntry_NamedSets> StorageEntriesToUpdate, const FLootLockerServerUpdatePersistentStorageForPlayersAndKeysResponseDelegate& OnCompleteResponse = FLootLockerServerUpdatePersistentStorageForPlayersAndKeysResponseDelegate());
	static void DeletePersistentStorageForPlayersAndKeys(TArray<int> PlayerIDs, TArray<FString> Keys, const FLootLockerServerDeletePersistentStorageForPlayersAndKeysResponseDelegate& OnCompleteResponse = FLootLockerServerDeletePersistentStorageForPlayersAndKeysResponseDelegate());
};
