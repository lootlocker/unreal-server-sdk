...
{
    ULootLockerServerHttpClient::SendRequest<FLootLockerServerGetPlayerCharactersResponse>(FLootLockerServerEmptyRequest{}, ULootLockerServerEndpoints::GetPlayerCharacters, { PlayerID }, {}, FLootLockerServerGetPlayerCharacterResponseBP(), OnCompletedRequest);
}
...
{
    ULootLockerServerHttpClient::SendRequest<FLootLockerServerGetCharacterInventoryResponse>(FLootLockerServerEmptyRequest{}, ULootLockerServerEndpoints::GetCharacterInventory, { PlayerID, CharacterID }, {}, FLootLockerServerGetCharacterInventoryResponseBP(), OnCompletedRequest);
}
...
void ULootLockerServerCharacterRequest::GetPaginatedPlayerCharacterInventory(int PlayerID, int CharacterID, int Count, int After, const FLootLockerServerGetCharacterInventoryResponseDelegate& OnCompletedRequest)
{
    ...
    ULootLockerServerHttpClient::SendRequest<FLootLockerServerGetCharacterInventoryResponse>(FLootLockerServerEmptyRequest{}, ULootLockerServerEndpoints::GetCharacterInventory, { PlayerID, CharacterID }, QueryParams, FLootLockerServerGetCharacterInventoryResponseBP(), OnCompletedRequest);
}
...
{
    ULootLockerServerHttpClient::SendRequest<FLootLockerServerGetCharacterLoadoutResponse>(FLootLockerServerEmptyRequest{}, ULootLockerServerEndpoints::GetCharacterLoadout, { PlayerID, CharacterID }, {}, FLootLockerServerGetCharacterLoadoutResponseBP(), OnCompletedRequest);
}
...
{
    ULootLockerServerHttpClient::SendRequest<FLootLockerServerEquipAssetToCharacterLoadoutResponse>(FLootLockerServerEquipAssetToCharacterLoadoutRequest{AssetInstanceID}, ULootLockerServerEndpoints::EquipAssetToCharacterLoadout, { PlayerID, CharacterID }, {}, FLootLockerServerEquipAssetToCharacterLoadoutResponseBP(), OnCompletedRequest);
}
...
{
    ULootLockerServerHttpClient::SendRequest<FLootLockerServerEquipAssetToCharacterLoadoutResponse>(FLootLockerServerEquipAssetToCharacterLoadoutByAssetIdAndRentalOptionIdRequest{AssetID, RentalOptionID}, ULootLockerServerEndpoints::EquipAssetToCharacterLoadout, { PlayerID, CharacterID }, {}, FLootLockerServerEquipAssetToCharacterLoadoutResponseBP(), OnCompletedRequest);
}
...
{
    ULootLockerServerHttpClient::SendRequest<FLootLockerServerUnequipAssetFromCharacterLoadoutResponse>(FLootLockerServerEmptyRequest{}, ULootLockerServerEndpoints::UnequipAssetFromCharacterLoadout, { PlayerID, CharacterID, InstanceID}, {}, FLootLockerServerUnequipAssetFromCharacterLoadoutResponseBP(), OnCompletedRequest);
}
