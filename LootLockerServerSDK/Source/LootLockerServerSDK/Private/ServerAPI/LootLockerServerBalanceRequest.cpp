...
{
	ULootLockerServerHttpClient::SendRequest<FLootLockerServerListBalancesForWalletResponse>(FLootLockerServerEmptyRequest{}, ULootLockerServerEndpoints::ListBalancesInWallet, { WalletID }, {}, FLootLockerServerListBalancesForWalletResponseBP(), OnComplete);
}
...
{
	ULootLockerServerHttpClient::SendRequest<FLootLockerServerGetWalletResponse>(FLootLockerServerEmptyRequest{}, ULootLockerServerEndpoints::GetWalletByWalletId, { WalletID }, {}, FLootLockerServerGetWalletResponseBP(), OnComplete);
}
			...
			const auto CreateWalletResponseHandler = FLootLockerServerCreateWalletResponseDelegate::CreateLambda([HolderULID, OnComplete, Response](const FLootLockerServerCreateWalletResponse& CreateWalletResponse)
				{
					...
					ULootLockerServerHttpClient::SendRequest<FLootLockerServerGetWalletResponse>(FLootLockerServerEmptyRequest{}, ULootLockerServerEndpoints::GetWalletByHolderId, { HolderULID }, {}, FLootLockerServerGetWalletResponseBP(), OnComplete);
				});
...
void ULootLockerServerBalanceRequest::CreditBalanceToWallet(const FString& WalletID, const FString& CurrencyID, const FString& Amount, const FLootLockerServerCreditWalletResponseDelegate& OnComplete)
{
	...
	ULootLockerServerHttpClient::SendRequest<FLootLockerServerCreditWalletResponse>(FLootLockerServerCreditRequest{ Amount, CurrencyID, WalletID }, ULootLockerServerEndpoints::CreditBalanceToWallet, {}, {}, FLootLockerServerCreditWalletResponseBP(), OnComplete);
}
...
{
	ULootLockerServerHttpClient::SendRequest<FLootLockerServerDebitWalletResponse>(FLootLockerServerDebitRequest{ Amount , CurrencyID, WalletID }, ULootLockerServerEndpoints::DebitBalanceToWallet, {}, {}, FLootLockerServerDebitWalletResponseBP(), OnComplete);
}
...
void ULootLockerServerBalanceRequest::CreateWallet(const FString& HolderULID, const ELootLockerServerWalletHolderTypes& HolderType, const FLootLockerServerCreateWalletResponseDelegate& OnComplete)
{
	ULootLockerServerHttpClient::SendRequest<FLootLockerServerCreateWalletResponse>(FLootLockerServerCreateWalletRequest{ HolderULID, ULootLockerServerEnumUtils::GetEnum(TEXT("ELootLockerServerWalletHolderTypes"), static_cast<int32>(HolderType)).ToLower() },
		ULootLockerServerEndpoints::CreateWallet, {}, {}, FLootLockerServerCreateWalletResponseBP(), OnComplete);
}
