...
void ULootLockerServerAssetRequest::GetAssets(int Count, int After, int Context, const FLootLockerServerGetAssetsResponseBP& OnCompletedRequestBP, const FLootLockerServerGetAssetsResponseDelegate& OnCompletedRequest)
{
